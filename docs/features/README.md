...
| [dashboard](dashboard.md) | draft | Phase 4 | Net Worth + asset allocation (pure read models). Multi-currency arrays, optional customerId on both endpoints, Closed excluded, Credit = liability, signed-sum locked, API only. |
