...
| Date | Change |
| --- | --- |
| 2026-08-24 | Transactions slice: Domain `Transaction` inside Account; `/transactions` append-only endpoints (TenantAdmin + Adviser). Buy/Sell average-cost adjustments stay in the Account aggregate. Holding-delete guard added. |
