...
export function CustomerFilters({ search, enabled, onApply }: CustomerFiltersProps) {
  ...
  return (
    ...
    >
      <label className="flex min-w-0 flex-1 flex-col gap-1 text-sm" htmlFor="customer-search">
        Search
        <input
          id="customer-search"
          type="search"
      ...
      <label className="flex flex-col gap-1 text-sm" htmlFor="customer-enabled">
        Status
        <select
          id="customer-enabled"
          name="isEnabled"
